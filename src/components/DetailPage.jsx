...
const DetailPage = () => {
  ...
  return (
    <Box sx={{ borderColor: "hsl(0 0 30%)" }} className="w-[600px] h-[600px] rounded-[48px] mx-auto border-1 flex flex-col justify-between p-12 relative">
      <Button sx={{ justifyContent: "start", position: 'absolute', top: "23px", padding: 0, color: "hsl(0 0 30%)", "&:hover": { color: "hsl(0 0 60%)" } }}
        onClick={() => navigate("/")}>
      ...
      <Typography sx={{ fontSize: "20px", lineHeight: "1", color: "hsl(0 0 90%)" }}>{animalData.description}</Typography>
    </Box>
  )
}
